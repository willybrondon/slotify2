...
const DashBoard = () => {
  ...
  const mapData = [
    ...
    },
    {
      ...
      Cell: ({ row }) => (
        <span>{row?.expertEarning + " " + setting?.currencySymbol}</span>
      ),
    },
    {
      Header: "Salon Commission",
      Cell: ({ row }) => (
        <span>{row?.salonCommission + " " + setting?.currencySymbol}</span>
      ),
    },
  ];
        ...
        <div className="row">
          ...
          <div className="col-lg-3 col-sm-6 col-12">
            <DashBox
              ...
              amount={
                counts?.revenue
                  ? counts?.revenue?.toFixed(2) + " " + setting?.currencySymbol
                  : 0
              }
              onClick={() => navigate("/salonPanel/dailyBookingTable")}
            />
          </div>
          <div className="col-lg-3 col-sm-6 col-12">
            <DashBox
