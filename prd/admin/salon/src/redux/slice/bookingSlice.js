...
export const getAllBookings = createAsyncThunk(
  "salon/booking/getAll",
  async (payload) => {
    return apiInstanceFetch.get(
      `salon/booking/getAll?start=${payload?.start}&limit=${payload?.limit}&type=${payload?.type}&startDate=${payload?.startDate}&endDate=${payload?.endDate}`
    );
  }
);

export const upcomingBookings = createAsyncThunk(
  "salon/booking/upcoming",
  async (type) => {
    return apiInstanceFetch.get(`salon/booking/upcoming?type=${type}`);
  }
);

export const dailyBookings = createAsyncThunk(
  "salon/booking/dailyBookingStats",
  async (payload) => {
    return apiInstanceFetch.get(
      `salon/booking/dailyBookingStats?start=${payload?.start}&limit=${payload?.limit}&startDate=${payload?.startDate}&endDate=${payload?.endDate}`
    );
  }
);

export const cancelBooking = createAsyncThunk(
  "salon/booking/cancelBooking",
  async (payload) => {
    return apiInstanceFetch.put(`salon/booking/cancelBooking`, payload);
  }
);
