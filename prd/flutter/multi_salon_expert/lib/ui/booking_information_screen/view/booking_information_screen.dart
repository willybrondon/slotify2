    ...
    return Scaffold(
      ...
      body: GetBuilder<BookingInformationController>(
        ...
        builder: (logic) {
          ...
          num expenses = (logic.getBookingInformationCategory?.booking?.platformFee ?? 0) +
              double.parse((logic.getBookingInformationCategory?.booking?.salonCommission.toString()) ?? '0');

          log("Other Expenses :: $expenses");
