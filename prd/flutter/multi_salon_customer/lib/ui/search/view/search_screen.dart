      ...
      onWillPop: () async {
        ...
        if (currentFocus.focusedChild != null) {
          homeScreenController.isSelected = List.generate(
              ...
              (index) =>
                  homeScreenController.checkItem.contains(homeScreenController.getAllServiceCategory?.services?[index].name));
          ...
          homeScreenController.onGetAllServiceApiCall();
        }
                        ...
                        builder: (logic) {
                          return RefreshIndicator(
                            onRefresh: () {
                              ...
                              return logic.onGetAllServiceApiCall();
                            },
