              ...
              {loader === true ? (
                <>
                  <SkeletonTheme baseColor="#e2e5e7" highlightColor="#fff">
                    ...
                    <Skeleton height={40} className="mb-5 border-bottom" />
                ...
                <>
                  <div className="position-relative">
                    ...
                    />
                    <img
                      src={!data?.image?.includes("\\") ? data?.image : Male}
                      alt="admin"
              ...
              <div className="card ">
                <div className="card-body">
                  {loader === true ? (
                    ...
                    <div className="col-sm-12 col-md-12 col-lg-9 col-xl-9 col-xxl-9 mx-auto">
                      <div className="form-group ">
                        <div className="mb-1 mt-1 inputData">
                      ...
                      <div className="form-group inputData">
                        <div className="mb-2 mt-2">
                          ...
                          <div className="interested-topics">
                            <Multiselect
                              // options={serviceList}
                              selectedValues={data?.serviceData?.map(
                                (item) => ({
                                  id: item._id,
                                  name: item.name,
                                })
