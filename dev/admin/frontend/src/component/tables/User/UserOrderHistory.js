                ...
                <div className="mt-2 col-4">
                    <div className="inputData">
                        ...
                        <div className="d-flex justify-content-start  gap-2">
                            <Button
                                className="bg-secondary text-white p3-y"
                                onClick={() => {
                                    setStatusType("All")
                                }}
                                text={`All`}
                            />
                            <Button
                                className="bg-info text-white p3-y"
                                onClick={() => {
                            ...
                            />
                            <Button
                                className="bg-primary text-white p3-y"
                                onClick={() => {
                            ...
                            />
                            <Button
                                className="bg-danger text-white p3-y"
                                onClick={() => {
