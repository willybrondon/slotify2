...
import AppointMentDialogue from "../appointment/AppointMentDialogue";
...
;
  const { salon, salonDetail } = useSelector((state) => state.salon);
  ...
  const handleCompleteOpenDialogue = (row) => {
    dispatch(openDialog({ type: "complete", data: row }));
  };
  ...
  const removeUser = (file) => {
    setSelectedUser(null);
  };

  // const handleOpenAppointment = () => {
  //   dispatch(openDialog({ type: "appointment" }));
  // };
  ...
  return (
    <div className="mainBooking">
      ...
      {dialogue && dialogueType === "complete" && (
        <CompleteBookingDetails setData={setData} data={data} />
      )}

      {/* {dialogue && dialogueType === "appointment" && <AppointMentDialogue />} */}
      ...
      <div className="row">
        ...
        <div className="col-md-9 d-flex">
          ...
          {/* <div className="d-flex justify-content-center align-items-center m26-top">
            <button
              className="themeButton bg-button p-10 text-white"
              type="button"
            ...
            <>
              <div className="row mt-2">
                ...
                <div className="col-6">
                  ...
                  />
                  {error.time && (
                    <p className="errorMessage text-capitalize">{error.time}</p>
                  )}
                </div>
              </div>
              <div className="row">
                <div
                  className={`col-12 ${
                    selectedUser?.length > 0 ? "d-none" : "d-block"
                  }`}
                >
                  <div className="inputData">
