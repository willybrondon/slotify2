...
route.post("/depositeToWallet", checkAccessWithSecretKey(), userController.depositeToWallet);
route.get("/walletHistoryByUser", checkAccessWithSecretKey(), userController.walletHistoryByUser);
