...
const COPY = {
  fr: {
    ...
    afroProjectBadge: "Sur mesure",
    afroFromPrice: "à partir de",
    afroDurationHint: "durée selon votre cheveu",
    afroConfigTitle: "Précisez votre prestation",
    afroConfigHint: "Quelques précisions pour __NAME__ — pour un prix et une durée réalistes.",
    afroSeeQuote: "Continuer",
    afroQuoteTitle: "Prix & durée estimés",
    afroQuoteHint: "Ces estimations suivent votre réservation jusqu’à la confirmation.",
    afroQuoteLocked: "Estimation personnalisée",
    afroEstimatedDuration: "Durée estimée",
    afroDeposit: "Acompte",
    afroBalanceDue: "Reste au salon",
    afroAcceptQuote: "",
    afroReviewTitle: "Presque prêt",
    afroReviewHint:
      "Le salon pourra confirmer ou vous poser une question précise si besoin. Vous pouvez continuer votre réservation.",
    afroClose: "Fermer",
    afroPhotoLabel: "Lien photo d’inspiration",
    afroPhotoOptional: "Lien photo (optionnel)",
    afroPhotoHint: "Collez un lien Instagram / Drive / image publique.",
    afroPhotoRequired: "Une photo d’inspiration aide le salon à bien préparer votre RDV.",
    ...
    afroServiceInfoDuration: "Prévoir __MIN__–__MAX__ min selon complexité",
    afroContinuePending: "Continuer la réservation",
    afroConfirmUnified:
      "Réservation enregistrée. Prix et durée estimés sont inclus dans cette confirmation.",
  ...
  en: {
    ...
    afroProjectBadge: "Custom",
    afroFromPrice: "from",
    afroDurationHint: "duration depends on your hair",
    afroConfigTitle: "Tell us about your style",
    afroConfigHint: "A few details for __NAME__ — for a realistic price and duration.",
    afroSeeQuote: "Continue",
    afroQuoteTitle: "Estimated price & duration",
    afroQuoteHint: "These estimates stay with your booking through confirmation.",
    afroQuoteLocked: "Personalized estimate",
    afroEstimatedDuration: "Estimated duration",
    afroDeposit: "Deposit",
    afroBalanceDue: "Balance at salon",
    afroAcceptQuote: "",
    afroReviewTitle: "Almost ready",
    afroReviewHint:
      "The salon may confirm or ask one precise question if needed. You can continue booking.",
    afroClose: "Close",
    afroPhotoLabel: "Inspiration photo link",
    afroPhotoOptional: "Photo link (optional)",
    afroPhotoHint: "Paste an Instagram / Drive / public image URL.",
    afroPhotoRequired: "An inspiration photo helps the salon prepare your visit.",
    ...
    afroServiceInfoDuration: "Allow __MIN__–__MAX__ min depending on complexity",
    afroContinuePending: "Continue booking",
    afroConfirmUnified:
      "Booking saved. Estimated price and duration are included in this confirmation.",
