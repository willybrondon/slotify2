...
2. **Settings Screen**: `lib/ui/setting_screen/view/setting_screen.dart`
   - Delete Account menu item (line 71-86)
   - Available only for logged-in users

3. **API Integration**: `lib/ui/setting_screen/controller/setting_controller.dart`
   - `onDeleteUserApiCall()` method
   - Calls backend endpoint: `user/delete`

4. **Localization**: `lib/language/english_language.dart`
