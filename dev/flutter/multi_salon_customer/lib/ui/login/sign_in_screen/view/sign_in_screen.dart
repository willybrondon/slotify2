                  ...
                  child: Column(
                    children: [
                      Text(
                        "txtEnterUsername".tr,
                        style:
                            TextStyle(color: AppColors.primaryTextColor, fontSize: 21, fontFamily: FontFamily.sfProDisplayBold),
                      ).paddingOnly(top: 20),
                      Text(
                        "txtFillDetails".tr,
                        style: TextStyle(color: AppColors.email, fontSize: 13.5, fontFamily: FontFamily.sfProDisplayRegular),
                            ...
                            builder: (logic) {
                              return InkWell(
                                ...
                                child: Text(
                                  "txtRememberMe".tr,
                                  style: TextStyle(
                                      color: AppColors.primaryTextColor, fontFamily: FontFamily.sfProDisplayMedium, fontSize: 15),
                                ),
                              );
                            },
                          ),
                          ...
                          text: TextSpan(
                            ...
                            children: <TextSpan>[
                              TextSpan(
                                  text: ' ${"txtSignUp".tr}',
                                  style: TextStyle(
                                      fontSize: 16, fontFamily: FontFamily.sfProDisplay, color: AppColors.categoryService)),
                            ],
                          ),
