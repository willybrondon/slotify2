...
import 'package:salon_2/ui/login/sign_in_screen/model/check_user_model.dart';
...
class SignInController extends GetxController {
  ...
  onClickSignIn() async {
    if (formKey.currentState!.validate()) {
      ...
      //     Constant.storage
      //         .write('mobileNumber', loginScreenController.loginCategory?.user?.mobile.toString());
      ...
      if (googleSignInAccount != null) {
        ...
        if (userCredential.user != null) {
          ...
          if (loginScreenController.loginCategory?.status == true) {
            ...
            Constant.storage.write('isGoogle', true);
            Constant.storage.write('UserId', loginScreenController.loginCategory?.user?.id);
