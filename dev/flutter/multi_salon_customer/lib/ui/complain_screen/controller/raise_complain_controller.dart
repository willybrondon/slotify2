...
class RaiseComplainController extends GetxController {
  ...
  onRaiseComplainApiCall(
      {String? userId, required String bookingId, String? details, required String selectImageFile}) async {
    try {
      isLoading(true);
      update([Constant.idProgressView]);

      final body = json
          .encode({"userId": userId, "bookingId": bookingId, "details": details, "image": selectImageFile});
