                    ...
                    children: [
                                  ...
                                  child: GestureDetector(
                                    ...
                                    child: Container(
                                      ...
                                      child: Text(
                                        ...
                                        style: TextStyle(
                                            fontFamily: AppFontFamily.sfProDisplay, fontSize: 12, color: AppColors.service),
                                      ),
                                    ),
                                  ),
                                ),
                              ...
                              child: Row(
                                children: [
                                  Text(
                                    "txtSubtotal".tr,
                                    style:
                                        TextStyle(fontFamily: AppFontFamily.sfProDisplay, fontSize: 15, color: AppColors.service),
                                  ),
                                  const Spacer(),
                                  Text(
                      ...
                      logic.getBookingInformationCategory?.booking?.status == "cancel"
                          ? Align(
                              alignment: Alignment.centerLeft,
                              child: Text(
                                "* ${"CancelledBy".tr} ${logic.getBookingInformationCategory?.booking?.cancel?.person}",
                                style: TextStyle(
                                  fontSize: 15,
                                  fontFamily: AppFontFamily.sfProDisplayMedium,
