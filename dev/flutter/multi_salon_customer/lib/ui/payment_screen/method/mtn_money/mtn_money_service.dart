...
class MTNMoneyService {
  static late String mtnMoneyApiKey;
  static late String mtnMoneyApiSecret;
  ...
  init({
    ...
    log("MTN Money API Secret :: $mtnMoneyApiSecret");
    ...
    this.mtnMoneyApiKey = mtnMoneyApiKey ?? "";
    this.mtnMoneyApiSecret = mtnMoneyApiSecret ?? "";
  ...
  Future<dynamic> mtnMoneyPay() async {
    log("MTN Money Payment Started");
    ...
    try {
      // Simulate MTN Money payment process
      // In a real implementation, you would integrate with MTN Money API
      log("Initiating MTN Money payment for amount: $totalAmountWithOutTaxs");
      ...
      if (paymentSuccess) {
        log("MTN Money payment successful");
        handlePaymentSuccess();
        return {"status": "success", "message": "Payment successful"};
      } else {
        log("MTN Money payment failed");
        throw "Payment failed. Please try again.";
      }
    } catch (e) {
      log("MTN Money payment error: $e");
      throw e.toString();
    }
  }

  void handlePaymentSuccess() {
    log("MTN Money Payment Success - Handling success");
