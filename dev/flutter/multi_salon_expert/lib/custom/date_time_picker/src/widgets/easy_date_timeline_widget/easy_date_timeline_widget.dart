...
class _EasyDateTimeLineState extends State<EasyDateTimeLine> {
  ...
  Widget build(BuildContext context) {
    ...
    final activeDayTextColor = brightness == Brightness.light ? EasyColors.dayAsNumColor : Colors.white;
            ...
            Padding(
              ...
              child: Row(
                ...
                children: [
                  ...
                  if (_showMonthPicker(pickerType: MonthPickerType.dropDown)) child!,
