...
class AppColors {
  ...
  static Color greyText = const Color(0xffA5A5A5);
  static Color switchBox = const Color(0xffEFF1F9);
  static Color holidayBg = const Color(0xffFFF1F1);
  static Color yellowBg = const Color(0xffFFF9E3);
  static Color reviewText = const Color(0xff767676);
  ...
  static Color idBg = const Color(0xffF5F5F5);
  static Color detailGrey = const Color(0xff8C8C8C);
  static Color textFieldBg = const Color(0xffF9F9F9);
  static Color idTextColor = const Color(0xff89908B);
  static Color cancelBooking = const Color(0xffFF6779);
  static Color checkOutBooking = const Color(0xff3A473E);
  static Color checkInBooking = const Color(0xff47C863);
